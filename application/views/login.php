	...
	<body class="login">
		...
		<div class="content">
			...
			<form class="forget-form" action="index.html" method="post">
				...
				<p>
					Masukkan nomer handphone Anda, sistem akan mengirimkan Kata Sandi pengingat Anda. 
				</p>
				<div class="form-group">
					<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Masukkan No. Handphone" name="no_hp"/>
				</div>
				<div class="form-actions">
					<button type="button" id="back-btn" class="btn btn-default">Kembali</button>
					<button type="submit" class="btn btn-success uppercase pull-right">Kirim</button>
				</div>
			</form>
