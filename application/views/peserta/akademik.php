		...
		<div class="portlet light bordered">
	      	<div class="portlet-title">
		        <div class="caption caption-md font-red-sunglo">
					...
					<span class="caption-subject theme-font bold uppercase">Bidang IPA</span>
				</div>
		        <div class="actions">
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
	      	<div class="portlet-title">
		        <div class="caption caption-md font-red-sunglo">
					<i class="fa fa-calendar-o font-red-sunglo"></i>
					<span class="caption-subject theme-font bold uppercase">Bidang Matematika</span>
				</div>
		        <div class="actions">
		          <a title="" data-original-title="" class="btn btn-circle btn-icon-only btn-default fullscreen" href="#"></a>
		        </div>
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
	      	<div class="portlet-title">
		        <div class="caption caption-md font-red-sunglo">
					<i class="fa fa-calendar-o font-red-sunglo"></i>
					<span class="caption-subject theme-font bold uppercase">Bidang Bahasa Indonesia</span>
				</div>
		        <div class="actions">
		          <a title="" data-original-title="" class="btn btn-circle btn-icon-only btn-default fullscreen" href="#"></a>
		        </div>
