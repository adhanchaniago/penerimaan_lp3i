...
class Laporan extends CI_Controller
{
	...
	public function detail($no_pendaftaran)
	{
		...
		$data ['total_nilai']		= count($this->tbl_peserta->get_id($no_pendaftaran,1)) > 0?$this->tbl_peserta->get_id($no_pendaftaran,1)[0]->KEPUTUSAN:'0';
		$data ['keputusan']			= count($this->tbl_peserta->get_id($no_pendaftaran,1)) > 0?$this->tbl_peserta->get_id($no_pendaftaran,1)[0]->KETERANGAN:'';
